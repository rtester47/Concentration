...
public class Images {
	...
	// High Scores Menu Images
	
	// Credits GameState Images.
	
	// Theme Images.
	public static BufferedImage default_theme;
	public static BufferedImage user_chosen_theme;
	
/*	// Custom Cursor Image.
	public static BufferedImage custom_hand_cursor;
	public static BufferedImage custom_wait_cursor;*/
